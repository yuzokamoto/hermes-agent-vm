...
Start with a small operational set and add profiles only when evaluations justify them.

- `orchestrator`: decomposes work, manages the project board, delegates, and reports.
